                    ...
                    <div className="row justify-content-center text-center">
                        <div className="col-md-8 col-lg-6">
                            <div className="header">
                                <h1 style={{backgroundColor:"ButtonHighlight",fontStyle:"revert-layer"}}>Shoes Products</h1>
                            </div>
                        </div>
                    </div>
                    <div className="row">
                        ...
                        <div className="col-md-6 col-lg-4 col-xl-3">
                            <div id="product-1" className="single-product">
                                ...
                                <div className="part-2">
                                    ...
                                    <h3 className="product-title">Nike's Joyride shoes use tiny beads to make your runs more comfortable</h3>
